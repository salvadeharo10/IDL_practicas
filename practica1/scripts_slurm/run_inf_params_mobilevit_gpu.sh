...
#SBATCH --output=/home/salvadordeharoo/IDL/practica1/slurm_outputs/inf_mvit_gpu_%j.out
...
accelerate launch --config_file /home/salvadordeharoo/IDL/practica1/scripts_python/config_gpubasebase.yaml /home/salvadordeharoo/IDL/practica1/scripts_python/mobileViT_inf_params_gpu.py \
