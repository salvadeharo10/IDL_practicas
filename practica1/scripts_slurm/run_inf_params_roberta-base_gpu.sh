...
#SBATCH --output=/home/miguelvidalg/IDL/practica1/slurm_outputs/inf_roberta_gpu_mixed_%j.out
...
/home/miguelvidalg/IDL/practica1/scripts_python/roberta-base_params_inf_gpu.py \
