...
#SBATCH --output=/home/salvadordeharoo/IDL/practica1/slurm_outputs/train_roberta_cpu_deepspeed_%j.out
...
accelerate launch --config_file /home/salvadordeharoo/IDL/practica1/scripts_python/deepspeed_cpu_stage0.yaml /home/salvadordeharoo/IDL/practica1/scripts_python/roberta-base_train_params_cpu.py \
